...
if ( ! class_exists( 'Thim_Plugin' ) ) {
	class Thim_Plugin {
		...
		public function __construct( $slug = '', $is_wporg = false ) {
			...
			$this->messages = array( esc_attr__( 'Something went wrong!', 'wordpress-lms' ) );
		...
		public function get_text_status() {
			$arrText = array(
				'active'        => esc_attr__( 'Active', 'wordpress-lms' ),
				'inactive'      => esc_attr__( 'Inactive', 'wordpress-lms' ),
				'not_installed' => esc_attr__( 'Not Installed', 'wordpress-lms' )
			);
