...
$heading       = sprintf( esc_html__( 'Other results (Latest %d items)', 'elearningwp' ), $limit );
?>
...
if ( $history_count > 1 ) {
	...
	<div class="lp-group-content-wrap" id="lp-quiz-history">
		<table class="quiz-history">
			...
			<tr>
				...
				<th><?php esc_html_e( 'Time', 'elearningwp' ); ?></th>
				<th><?php esc_html_e( 'Result', 'elearningwp' ); ?></th>
			</tr>
			</thead>
	...
	learn_press_display_message( __( 'No history found!', 'elearningwp' ), 'notice');
}