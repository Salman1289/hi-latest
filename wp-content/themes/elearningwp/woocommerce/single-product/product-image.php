...
if ( has_post_thumbnail() ) {
	...
	echo '<div class="images product_variations_image '.$class_hide.'">';
	...
	$product_variations_thumbnail = apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" title="%s" class="woocommerce-main-image zoom" data-rel="prettyPhoto' . $gallery . '" style="">%s</a>', esc_url( $image_link ), esc_attr( $image_title ), $image ), $post->ID );
